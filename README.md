...
1. What does a keylogger conceptually collect?
2. How does ransomware behavior differ from normal file modification?
3. How does malware propagation work conceptually?
4. What types of information might an infostealer target?
5. Why is persistence important to malware?
6. What makes rootkit behavior difficult to detect?
7. How can defenders identify suspicious behavior?
